...
func init() {
	...
	prod4 := Product{
		ID:          4,
		Title:       "Graps",
		Description: "Graps are sour",
		Price:       50,
		ImgUrl:      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUu0Fe9UFtJLFHqTNH-N6nppkGp6yCkDnfvg&s",
	}
	prod5 := Product{
		ID:          5,
		Title:       "Mango",
		...
		Price:       70,
		ImgUrl:      "https://www.metropolisindia.com/upgrade/blog/upload/25/05/benefits-of-mangoes1747828357.webp",
	}
